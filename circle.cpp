...
void circle::draw(QGraphicsScene *scene, int width, int height)
{
...
void circle::getParametrs(int &side1, int &side2, int a)
{
    bool ok;
    side1 = QInputDialog::getInt(this, tr("Введите радиус:"), tr("Радиус:"), 100, 0, 10000, 1, &ok);
}

void circle::perSquareMasse(int width, int height)
{
